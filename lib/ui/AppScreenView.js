...
export default class AppScreenView extends React.Component {
    ...
    render(){
        ...
        if (mode === 'mobile') {
            return (
                <div key="main" ref="main" className="container-fluid main-container mode-mobile">
                    {this._renderMobileLayout()}
                </div>
            );
        } else if (mode === 'tablet') {
            return (
                <div key="main" ref="main" className="container-fluid main-container mode-tablet">
                    {this._renderTabletLayout()}
                </div>
            );
        } else if (mode === 'desktop') {
            return (
                <div key="main" ref="main" className="container-fluid main-container mode-desktop">
                    {this._renderDesktopLayout()}
                </div>
            );
        } else {
            return (
                <div key="main" ref="main" className="container-fluid main-container mode-embed">

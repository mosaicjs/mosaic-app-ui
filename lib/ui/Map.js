...
export default class Map extends React.Component {
    constructor(...params){
        super(...params);
        const model = this.model = this.props.app.model;
        const adapters = this.props.app.adapters;

        // TODO: externalize it 
        const layers = new DataSet({
            adapters
        });
        
        const tilesUrl = this.props.tilesUrl || 'http://{s}.tile.osm.org/{z}/{x}/{y}.png';
...
//            console.log('XXXXXXXXXXX', app.state.map.updateId,  that._updateId);
